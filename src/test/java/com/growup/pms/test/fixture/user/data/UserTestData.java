...
public final class UserTestData {
    ...
    public static User 에밀리() {
        return 사용자는()
                ...
                .프로필_이미지가("https://growup.kr/profiles/emily.png")
                .이다();
    }
    ...
    public static User 알렉스() {
        return 사용자는()
                ...
                .프로필_이미지가("https://growup.kr/profiles/alex.png")
                .이다();
    }
    ...
    public static User 소피아() {
        return 사용자는()
                ...
                .프로필_이미지가("https://growup.kr/profiles/sophia.png")
                .이다();
    }
    ...
    public static User 마이클() {
        return 사용자는()
                ...
                .프로필_이미지가("https://growup.kr/profiles/michael.png")
                .이다();
    }
    ...
    public static User 올리비아() {
        return 사용자는()
                ...
                .프로필_이미지가("https://growup.kr/profiles/olivia.png")
                .이다();
    }
    ...
    public static User 데이비드() {
        return 사용자는()
                ...
                .프로필_이미지가("https://growup.kr/profiles/david.png")
                .이다();
    }
    ...
    public static User 에마() {
        return 사용자는()
                ...
                .프로필_이미지가("https://growup.kr/profiles/emma.png")
                .이다();
    }
    ...
    public static User 라이언() {
        return 사용자는()
                ...
                .프로필_이미지가("https://growup.kr/profiles/ryan.png")
                .이다();
    }
}
