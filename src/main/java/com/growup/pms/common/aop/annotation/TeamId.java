...
/**
 * 메서드 파라미터가 팀 ID를 나타냄을 표시하는 마커 애노테이션입니다.
 ...
 * @RequireTeamPermission(TeamPermission.READ_TEAM)
 * public ResponseEntity<TeamDto> getTeam(@Positive @TeamId @PathVariable Long teamId) {
 *     // 메서드 구현
 * }
 * }
 * </pre>
