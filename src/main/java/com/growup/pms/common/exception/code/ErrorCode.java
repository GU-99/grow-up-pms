...
public enum ErrorCode {
    ...
    INVALID_EMAIL_VERIFICATION(ErrorCategory.AUTHENTICATION_ERROR, "004", "이메일 인증 번호가 일치하지 않습니다."),
    ...
    TEAM_MEMBER_NOT_FOUND(ErrorCategory.TEAM_ERROR, "003", "팀원을 찾을 수 없습니다."),
    UNAUTHORIZED_ROLE_ASSIGNMENT(ErrorCategory.TEAM_ERROR, "004", "허용되지 않은 역할 지정입니다."),
