...
public enum ErrorCode {
    ...
    EMAIL_ALREADY_EXISTS(CONFLICT, "US_006", "이미 등록된 이메일입니다. 다른 정보로 시도해 주세요."),
    ...
    TASK_PERIOD_OUT_OF_RANGE(BAD_REQUEST, "DF_003", "입력한 기간 범위가 올바르지 않습니다. 프로젝트 일정의 기간은 프로젝트 기간 내에 있어야 합니다."),
