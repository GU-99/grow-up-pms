...
public class UserService {
    ...
    public UserUpdateResponse updateUserDetails(Long userId, UserUpdateCommand command) {
        ...
        editFieldIfPresent(command.fileName(), (v, u) -> u.updateProfileImageName(v.get()), user);
    ...
    private void validateCurrentPassword(String storedPassword, String inputPassword) {
